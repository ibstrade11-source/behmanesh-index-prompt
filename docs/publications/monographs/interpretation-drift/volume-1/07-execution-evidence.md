...
Observed execution behaviors are treated as engineering evidence for
evaluating the proposed execution architecture.

They are not interpreted as descriptions of internal model cognition.
...
Recurring execution behaviors motivate architectural mechanisms within
BSI.
