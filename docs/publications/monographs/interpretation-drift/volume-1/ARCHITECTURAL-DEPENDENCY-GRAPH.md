...
Architectural dependencies are directional.

Higher-level architectural principles constrain implementation decisions,
whereas implementation outcomes shall never redefine architectural principles
without an explicit architectural revision process.
