...
---### Rule #7 — REIG Object Discipline
REIG فقط روی Draft Analysis اجرا می‌شود.
اگر REIG چک‌لیست خود را روی متن هدف اجرا کند،
این نقض مستقیم Pipeline است — به عنوان 
Methodological Drift ثبت و اصلاح شود.
